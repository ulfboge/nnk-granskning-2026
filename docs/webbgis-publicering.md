...
6. **Popup:** högerklicka → *Configure Pop-ups*. Rubrik `{omrade_namn}`, fältlista i prioriterad ordning (områdesnamn, skyddskategori, län, N2000-kod, naturtyp + klartext, status + klartext, granskningsfälten). Popupen följer med till webblagret som *standard-popup* och kan finjusteras i Map Viewer i del 5.
